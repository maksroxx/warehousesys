...
class _$InventoryItemImpl implements _InventoryItem {
  ...
  @override
  String toString() {
    return 'InventoryItem(id: $id, productId: $productId, productName: $productName, categoryId: $categoryId, categoryName: $categoryName, sku: $sku, unitName: $unitName, quantityOnStock: $quantityOnStock, characteristics: $characteristics)';
  }
